/*
  ...
  - You are about to drop the `saved_study_materials` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "saved_study_materials" DROP CONSTRAINT "saved_study_materials_documentId_fkey";

-- DropForeignKey
ALTER TABLE "saved_study_materials" DROP CONSTRAINT "saved_study_materials_userId_fkey";

-- DropTable
DROP TABLE "saved_study_materials";
